...
#ifndef OFFCENTER_COMMON_AMQPSERVER_IAMQPMANAGEDSERVERAPP_HPP_
#define OFFCENTER_COMMON_AMQPSERVER_IAMQPMANAGEDSERVERAPP_HPP_
...
#endif /* OFFCENTER_COMMON_AMQPSERVER_IAMQPMANAGEDSERVERAPP_HPP_ */
