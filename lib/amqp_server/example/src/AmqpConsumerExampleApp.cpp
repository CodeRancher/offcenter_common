...
void PersistOandaForexDataToCSV::onInitAMQP(offcenter::common::amqp::ConnectionURIOptions& options)
{
...
void PersistOandaForexDataToCSV::onInitAMQPSessions(offcenter::common::amqp::ConnectionPtr connection)
{
	// Create a Session
