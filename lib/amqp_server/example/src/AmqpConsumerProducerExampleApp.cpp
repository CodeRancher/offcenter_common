...
void AmqpConsumerProducerExampleApp::onInitAMQP(offcenter::common::amqp::ConnectionURIOptions& options)
{
...
void AmqpConsumerProducerExampleApp::onInitAMQPSessions(offcenter::common::amqp::ConnectionPtr connection)
{
	// Create a Session
