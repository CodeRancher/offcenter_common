...
#ifndef IMGUIEXAMPLEAPP_HPP_
#define IMGUIEXAMPLEAPP_HPP_
 ...
 *
 */
class ImGuiExampleApp: public offcenter::common::imgui::IImGuiApp {
public:
	explicit ImGuiExampleApp();
	virtual ~ImGuiExampleApp();
