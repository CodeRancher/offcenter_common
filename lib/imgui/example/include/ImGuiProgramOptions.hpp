...
/**
 * @file   ImGuiExampleProgramOptions.hpp
 * @author Scott Brauer
 * @date   12-01-2021
 */
#ifndef IMGUIEXAMPLEPROGRAMOPTIONS_HPP_
#define IMGUIEXAMPLEPROGRAMOPTIONS_HPP_
...
public:
	...
	virtual ~ImGuiExampleProgramOptions() = default;
};

#endif /* IMGUIEXAMPLEPROGRAMOPTIONS_HPP_ */
